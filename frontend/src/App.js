...
class App extends React.Component {
    ...
    createProject(name, urls_rep, users){
        ...
        axios.post('http://127.0.0.1:8080/api/project/', data, {headers}).then(response => {
            this.load_data()
    ...
    deleteProject(id){
        const headers = this.get_headers()
        axios.delete(`http://127.0.0.1:8080/api/project/${id}`, {headers}).then(response => {
            this.load_data()
        }).catch(error => console.log(error))
    }
    ...
    createToDo(text, is_active, project, users_name){
        ...
        axios.post('http://127.0.0.1:8080/api/ToDo/', data, {headers}).then(response => {
            this.load_data()
        }).catch(error => console.log(error))
    }
    ...
    deleteToDo(id){
        const headers = this.get_headers()
        axios.delete(`http://127.0.0.1:8080/api/ToDo/${id}`, {headers}).then(response => {
            this.load_data()
        }).catch(error => console.log(error))
    }
    ...
    searchProject(name){
        const headers = this.get_headers()
        axios.get(`http://127.0.0.1:8080/api/project/?search=${name}`, {headers}).then(response => {
            this.setState(
                {
    ...
    load_data(){
        ...
        axios.get("http://127.0.0.1:8080/api/project/", {headers}).then(response => {
            this.setState(
                {
                    'projects': response.data
                }
